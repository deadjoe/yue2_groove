...
<div id="bb-footer">
  ...
  <span>Developed by DEADJOE@GITHUB(<a href="https://github.com/deadjoe/yue2_groove" target="_blank" rel="noopener">yue2_groove</a>)</span>
    ...
    with gr.Blocks(title="YUE2 // GROOVE", fill_width=True) as demo:
        ...
        # ───── event wiring ─────
        model_args = [rail.device, rail.dtype, rail.backend, rail.quantization, rail.offload_ar, rail.budget, rail.ode_steps,
                      rail.vae_core_frames, rail.model, rail.vae_choice, rail.vae_custom, rail.revision, rail.vae_revision, rail.offline]
        gen_common = [gen.style, gen.lyrics, gen.cot, gen.seed, gen.cfg, gen.abc, gen.out_id, gen.preset,
                      gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max,
                      gen.sem_temp, gen.sem_p, gen.sem_k, gen.sem_rep, gen.sem_win, gen.sem_min, gen.sem_max] + model_args
        gen.run_btn.click(generate_tab.generate, inputs=gen_common,
                      outputs=[gen.audio_out, gen.score_out, gen.gen_status, gen.files_out,
                               gen.run_btn, gen.plan_btn, gen.gen_last_run])
        library_outputs_for_flow = [lib.lib_list, lib.lib_info, lib.lib_style, lib.lib_lyrics, lib.lib_abc,
                                    lib.lib_rename_box, lib.lib_rename_btn, lib.lib_status, tabs, lib.lib_active,
                                    current_bridge]
        edit_outputs_for_flow = [edit.edit_style, edit.edit_lyrics, edit.edit_abc, edit.edit_baseline_abc,
                                 edit.edit_source_rel, edit.edit_check_state, edit.edit_baseline_state,
                                 edit.edit_baseline_info, edit.edit_status, edit.edit_source, current_bridge,
                                 tabs]
        song_outputs = [song.song_empty, song.song_work, song.song_identity, song.song_stage, song.song_family,
                        song.song_player, song.song_score,
                        song.song_listen_btn, song.song_render_btn, song.song_edit_btn, song.song_retry_btn,
                        song.song_check_btn, song.song_send_btn, song.song_library_btn,
                        song.song_studio_btn, song.song_compare_btn]
        ...
        gen.open_library_btn.click(library_tab.open_last_in_library, inputs=[gen.gen_last_run],
                               outputs=library_outputs_for_flow)
        gen.gen_last_run.change(song_view.mirror_current, inputs=[gen.gen_last_run], outputs=[current_bridge])
        edit.edit_last_run.change(song_view.mirror_current, inputs=[edit.edit_last_run], outputs=[current_bridge])
        cov.cover_last_run.change(song_view.mirror_current, inputs=[cov.cover_last_run], outputs=[current_bridge])
        gen.gen_edit_btn.click(library_tab.library_open_in_edit, inputs=[gen.gen_last_run],
                           outputs=edit_outputs_for_flow)
        gen.plan_btn.click(generate_tab.plan_only,
                       inputs=[gen.style, gen.lyrics, gen.cot, gen.seed, gen.cfg, gen.out_id,
                               gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max]
                              + model_args,
                       outputs=[gen.score_out, gen.gen_status, gen.files_out, gen.run_btn, gen.plan_btn,
                                current_bridge])
        gen.allmodes_btn.click(generate_tab.generate_all_modes,
                           inputs=[gen.style, gen.lyrics, gen.seed, gen.cfg, gen.abc, gen.out_id,
                                   gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max,
                                   gen.sem_temp, gen.sem_p, gen.sem_k, gen.sem_rep, gen.sem_win, gen.sem_min, gen.sem_max]
                                  + model_args,
                           outputs=[gen.gen_status, gen.files_out, gen.allmodes_link,
                                    gen.run_btn, gen.plan_btn, gen.allmodes_btn, current_bridge])
        ...
        gen.preset.change(generate_tab.apply_preset, inputs=gen.preset,
        ...
        gen.sampling_reset_btn.click(generate_tab.reset_sampling_values,
                                 outputs=[gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max,
                                          gen.sem_temp, gen.sem_p, gen.sem_k, gen.sem_rep, gen.sem_win, gen.sem_min, gen.sem_max,
                                          gen.preset])
        ...
        gen.request_reset_btn.click(lambda: ("", "", "full", 831001, 0, ""),
        ...
        rail.runtime_reset_btn.click(
            ...
            outputs=[rail.device, rail.dtype, rail.model, rail.vae_choice, rail.vae_custom, rail.revision, rail.vae_revision,
                     rail.offline, rail.backend, rail.quantization, rail.offload_ar, rail.budget, rail.ode_steps, rail.vae_core_frames])
        ...
        dec.decode_btn.click(generate_tab.decode_run,
                         inputs=[dec.source_dir, dec.latent_upload, dec.dec_vae_choice, dec.dec_vae_custom,
                                 dec.dec_vae_revision, dec.full_decode] + model_args,
                         outputs=[dec.decode_audio, dec.decode_status, dec.decode_btn, current_bridge])
        dec.decode_reset_btn.click(lambda: ("standard", "", "", False),
                               outputs=[dec.dec_vae_choice, dec.dec_vae_custom, dec.dec_vae_revision, dec.full_decode])

        batch.batch_btn.click(generate_tab.batch_generate,
                        inputs=[batch.batch_text, batch.batch_file, batch.batch_id,
                                gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max,
                                gen.sem_temp, gen.sem_p, gen.sem_k, gen.sem_rep, gen.sem_win, gen.sem_min, gen.sem_max]
                              + model_args,
        ...
        tools.inspect_btn.click(tools_tab.abc_inspect, inputs=tools.abc_tool_text, outputs=tools.abc_result)
        tools.strip_btn.click(tools_tab.abc_strip_chords, inputs=[tools.abc_tool_text, tools.strip_voice], outputs=tools.abc_result)
        tools.compare_abc_btn.click(tools_tab.abc_compare, inputs=[tools.abc_tool_text, tools.abc_after, tools.compare_voice, tools.allow_tempo],
                              outputs=tools.abc_compare_out)
        tools.compare_btn.click(tools_tab.make_comparison, inputs=tools.compare_paths,
                          outputs=[tools.compare_file, tools.compare_link, tools.compare_status])
        tools.fill_btn.click(generate_tab.fill_from_batch, inputs=tools.batch_pick, outputs=tools.compare_paths)
        tools.batch_refresh.click(generate_tab.update_batch_choices, outputs=tools.batch_pick)
        tools.doctor_btn.click(tools_tab.run_doctor,
                         inputs=[rail.model, rail.vae_choice, rail.vae_custom, rail.revision, rail.vae_revision, rail.offline,
                                 tools.verify_hashes],
                         outputs=tools.doctor_out)
        rail.load_btn.click(lambda *values: runtime.load_pipeline(runtime.RuntimeSettings(*values))[1],
                       inputs=model_args, outputs=rail.env_status)
        rail.unload_btn.click(lambda: (runtime.unload_pipeline(), "Model unloaded")[1], outputs=rail.env_status)
        ...
        song.song_new_btn.click(lambda: (gr.update(selected="gen"), gr.update(value="studio")),
        ...
        song.song_edit_start_btn.click(
            ...
            outputs=[tabs, view_bridge])
        song.song_listen_btn.click(fn=None, js=frontend.SONG_LISTEN_JS, outputs=song.song_listen_btn)
        song.song_render_btn.click(
            song_view.song_render_action, inputs=[current_bridge],
            outputs=[gen.abc, gen.score_input_accordion, gen.style, gen.lyrics,
                     cov.cover_abc, cov.cover_style, cov.cover_lyrics, cov.cover_status, cov.cover_source,
                     current_bridge, tabs, view_bridge])
        song.song_edit_btn.click(song_view.song_open_edit, inputs=[current_bridge],
                            outputs=edit_outputs_for_flow + [view_bridge])
        song.song_check_btn.click(song_view.song_open_edit, inputs=[current_bridge],
                             outputs=edit_outputs_for_flow + [view_bridge])
        ...
        song.song_send_btn.click(
            ...
            outputs=[gen.abc, gen.cot, gen.style, gen.lyrics, gen.score_input_accordion, tabs, cov.cover_status,
                     view_bridge])
        song.song_library_btn.click(song_view.song_open_library, inputs=[current_bridge],
                               outputs=library_outputs_for_flow + [view_bridge])
        song.song_studio_btn.click(song_view.song_open_studio, inputs=[current_bridge],
                              outputs=[tabs, view_bridge])
        song.song_compare_btn.click(song_view.song_compare, inputs=[current_bridge],
        ...
        cover_controls = [cov.cover_btn, cov.cover_strip_btn, cov.cover_send_btn, cov.cover_generate_btn,
                          cov.cover_env_btn, cov.cover_unload_btn, cov.cover_keep_warm]
        cov.cover_btn.click(cover_tab.cover_transcribe,
                        inputs=[cov.cover_audio, cov.cover_task, cov.cover_max_seconds, cov.cover_model,
                                cov.cover_device, cov.cover_dtype, cov.cover_revision, cov.cover_base_model,
                                cov.cover_keep_warm, cov.cover_offline],
                        outputs=[cov.cover_abc, cov.cover_files, cov.cover_status, *cover_controls,
                                 cov.cover_generate_accordion, cov.cover_source, current_bridge])
        cov.cover_generate_btn.click(
            cover_tab.cover_generate,
            inputs=[cov.cover_style, cov.cover_lyrics, cov.cover_abc, cov.cover_task, cov.cover_keep, cov.cover_seed,
                    cov.cover_cfg,
                    gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max,
                    gen.sem_temp, gen.sem_p, gen.sem_k, gen.sem_rep, gen.sem_win, gen.sem_min, gen.sem_max] + model_args,
            outputs=[cov.cover_status, cov.cover_result_audio, cov.cover_result_abc, cov.cover_gen_files,
                     *cover_controls, cov.cover_last_run])
        cov.cover_open_library_btn.click(library_tab.open_last_in_library, inputs=[cov.cover_last_run],
                                     outputs=library_outputs_for_flow)
        ...
        cov.cover_load_btn.click(cover_tab.cover_load, inputs=[cov.cover_source],
        ...
        cov.cover_send_edit_btn.click(
            ...
            outputs=[edit.edit_abc, edit.edit_baseline_abc, edit.edit_style, edit.edit_lyrics, edit.edit_source_rel,
                     edit.edit_check_state, edit.edit_baseline_state, edit.edit_baseline_info, edit.edit_status,
                     edit.edit_source, current_bridge, tabs])
        cov.cover_strip_btn.click(cover_tab.cover_strip, inputs=[cov.cover_abc, cov.cover_keep],
                              outputs=[cov.cover_abc, cov.cover_status])
        cov.cover_send_btn.click(cover_tab.cover_send_to_generate,
                             inputs=[cov.cover_abc, cov.cover_task, cov.cover_style, cov.cover_lyrics, cov.cover_keep],
                             outputs=[gen.abc, gen.cot, gen.style, gen.lyrics, gen.score_input_accordion, tabs,
                                      cov.cover_status])
        ...
        edit_tab_ui.select(cover_tab.sampling_summary,
                        inputs=[gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max,
                                gen.sem_temp, gen.sem_p, gen.sem_k, gen.sem_rep, gen.sem_win, gen.sem_min, gen.sem_max],
        ...
        edit.edit_load_btn.click(
            edit_tab.edit_load, inputs=[edit.edit_source],
            outputs=[edit.edit_style, edit.edit_lyrics, edit.edit_abc, edit.edit_baseline_abc, edit.edit_source_rel,
                     edit.edit_check_state, edit.edit_baseline_state, edit.edit_baseline_info, edit.edit_status])
        edit.edit_freeze_btn.click(edit_tab.edit_freeze, inputs=[edit.edit_source_rel, edit.edit_source],
                              outputs=[edit.edit_baseline_state, edit.edit_baseline_info, edit.edit_status])
        edit.edit_check_btn.click(
            edit_tab.edit_check,
            inputs=[edit.edit_baseline_abc, edit.edit_abc, edit.edit_voice, edit.edit_allow_tempo,
                    edit.edit_baseline_state, edit.edit_contract, edit.edit_allow_meter],
            outputs=[edit.edit_check_out, edit.edit_check_state])
        edit.edit_run_btn.click(
            edit_tab.edit_generate,
            inputs=[edit.edit_style, edit.edit_lyrics, edit.edit_cot, edit.edit_seed, edit.edit_cfg, edit.edit_abc,
                    edit.edit_baseline_abc, edit.edit_source_rel, edit.edit_check_state, edit.edit_allow_changes,
                    edit.edit_baseline_state,
                    gen.abc_temp, gen.abc_p, gen.abc_k, gen.abc_rep, gen.abc_win, gen.abc_min, gen.abc_max,
                    gen.sem_temp, gen.sem_p, gen.sem_k, gen.sem_rep, gen.sem_win, gen.sem_min, gen.sem_max] + model_args,
            outputs=[edit.edit_audio, edit.edit_result_abc, edit.edit_files, edit.edit_status,
                     edit.edit_run_btn, edit.edit_check_btn, edit.edit_freeze_btn, edit.edit_load_btn,
                     edit.edit_refresh_btn, edit.edit_compare_btn, edit.edit_last_run])
        edit.edit_cancel_btn.click(runtime.cancel_run, outputs=edit.edit_status)
        edit.edit_library_btn.click(library_tab.open_last_in_library, inputs=[edit.edit_last_run],
                               outputs=library_outputs_for_flow)
        edit.edit_compare_btn.click(edit_tab.edit_compare, inputs=[edit.edit_source_rel, edit.edit_last_run],
                               outputs=[edit.edit_compare_file, edit.edit_compare_link, edit.edit_compare_status])

        # ───── library wiring (toolkit in library.py) ─────
        library_outputs = [lib.lib_list, lib.lib_info, lib.lib_style, lib.lib_lyrics, lib.lib_abc,
                           lib.lib_rename_box, lib.lib_rename_btn, lib.lib_status]
        ...
        lib.lib_refresh_btn.click(library_tab.library_refresh,
                              inputs=[lib.lib_sort_key, lib.lib_sort_dir, lib.lib_list, lib.lib_active],
                              outputs=library_outputs)
        lib.lib_sort_key.change(library_tab.library_refresh,
                            inputs=[lib.lib_sort_key, lib.lib_sort_dir, lib.lib_list, lib.lib_active],
                            outputs=library_outputs)
        lib.lib_sort_dir.change(library_tab.library_refresh,
                            inputs=[lib.lib_sort_key, lib.lib_sort_dir, lib.lib_list, lib.lib_active],
                            outputs=library_outputs)
        # row click = view/play only (JS sets the hidden bb-lib-active box)
        lib.lib_active.change(library_tab.library_view, inputs=[lib.lib_active],
                          outputs=[lib.lib_info, lib.lib_style, lib.lib_lyrics, lib.lib_abc,
                                   lib.lib_rename_box, lib.lib_rename_btn])
        lib.lib_rename_btn.click(library_tab.library_rename,
                             inputs=[lib.lib_active, lib.lib_rename_box, lib.lib_sort_key, lib.lib_sort_dir, lib.lib_list],
                             outputs=[lib.lib_list, lib.lib_info, lib.lib_style, lib.lib_lyrics, lib.lib_abc,
                                      lib.lib_rename_box, lib.lib_rename_btn, lib.lib_status, lib.lib_active])
        lib.lib_edit_btn.click(library_tab.library_open_in_edit, inputs=[lib.lib_active],
                           outputs=edit_outputs_for_flow)
        lib.lib_cover_btn.click(library_tab.library_use_in_cover, inputs=[lib.lib_active],
                            outputs=[cov.cover_abc, cov.cover_style, cov.cover_lyrics, cov.cover_status,
                                     cov.cover_source, current_bridge, tabs])
        lib.lib_delete_btn.click(library_tab.library_delete_prepare,
        ...
        lib.lib_confirm_btn.click(library_tab.library_delete_confirm,
                              inputs=[lib.lib_pending, lib.lib_sort_key, lib.lib_sort_dir, lib.lib_active],
                              outputs=[lib.lib_list, lib.lib_info, lib.lib_style, lib.lib_lyrics, lib.lib_abc,
                                       lib.lib_rename_box, lib.lib_rename_btn,
                                       lib.lib_confirm, lib.lib_pending, lib.lib_confirm_btn, lib.lib_status,
                                       lib.lib_active])
        lib.lib_cancel_btn.click(library_tab.library_delete_cancel,
                             outputs=[lib.lib_confirm, lib.lib_pending, lib.lib_confirm_btn, lib.lib_status])
        demo.load(library_tab.library_refresh, inputs=[lib.lib_sort_key, lib.lib_sort_dir, lib.lib_list, lib.lib_active],
                  outputs=library_outputs)
